 ...
 */
public class StopProgramsCommand extends BatchLifecycleCommand<BatchProgram> {
  ...
  public String getPattern() {
    return String.format("stop app programs <%s> [types <%s>]", ArgumentName.APP, ArgumentName.PROGRAM_TYPES);
  }
