 ...
 */
public class StartProgramsCommand extends BatchLifecycleCommand<BatchProgramStart> {
  ...
  public String getPattern() {
    return String.format("start app programs <%s> [types <%s>]", ArgumentName.APP, ArgumentName.PROGRAM_TYPES);
  }
