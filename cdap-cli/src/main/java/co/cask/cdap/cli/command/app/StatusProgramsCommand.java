 ...
 */
public class StatusProgramsCommand extends BatchLifecycleCommand<BatchProgram> {
  ...
  public String getPattern() {
    return String.format("get status app programs <%s> [types <%s>]", ArgumentName.APP, ArgumentName.PROGRAM_TYPES);
  }
