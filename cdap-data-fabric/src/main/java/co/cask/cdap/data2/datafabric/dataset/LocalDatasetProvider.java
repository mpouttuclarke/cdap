...
/**
 * Provides {@link Dataset} instances directly using {@link DatasetMetaProvider}.
 */
...
public class LocalDatasetProvider implements DatasetProvider {
  ...
  public LocalDatasetProvider(DatasetDefinitionRegistryFactory registryFactory, DatasetMetaProvider metaProvider) {
